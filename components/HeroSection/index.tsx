...
const HeroSection: React.FC = () => {
  return (
    <div className="relative w-full h-screen flex flex-col justify-center items-center bg-white text-black" style={{ backgroundImage: 'radial-gradient(#FFDC58 1px, transparent 1px)', backgroundSize: '10px 10px' }}>
      <div className="flex flex-col items-center mt-10"> {/* Adjusted margin-top */}
        ...
        <p className="text-medium-title font-mono mb-6 drop-shadow-lg inline-flex items-center">
          ...
          <Image src="/Smile.svg" alt="Smile" width={27} height={27} className="ml-2" />
        </p>
